...
class SysMenu(models.Model):
    ...
    component = models.CharField(max_length=255, null=True, verbose_name='组建路径')
    ...
    create_time = models.DateField(null=True, auto_now_add=True, verbose_name='创建时间')
    update_time = models.DateField(null=True, auto_now=True, verbose_name='更新时间')
    remark = models.CharField(max_length=500, null=True, verbose_name='备注')

    def __lt__(self, other):
        return self.order_num < self.order_num
